    ...
    public static void main(String[] args) {
        ...
        get("/images", ((request, response)->
                "<!DOCTYPE html>" +
                        ...
                        "<ul>" +
                        "<li><img src='/home/moringa/IdeaProjects/Spark2/src/main/resources/public/images/moringaschool.png' alt='A photo of a mountain range.'/></li>" + "<li><img src='/images/2.3water-nature-ex.jpg' alt='A photo of a swamp.'/></li>" + "</ul>" + "</body>" + "</html>"
        ));
    }
}
